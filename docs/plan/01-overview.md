...
Each model can additionally be run with SDM-derived pollinator activity curves instead of GBIF-derived ones, producing an -SDM variant (e.g. ANTHEIA-Scalar-SDM). See `docs/06-extensions-and-next-steps.md`.
