...
Model-predicted pollinator activity curves replacing GBIF-derived a_curves. Currently a small test set. Used for the SDM comparison results reported in `evaluation/03_sdm_comparison.ipynb`. See `docs/06-extensions-and-next-steps.md` for full details.
