...
GROUPS = [
    ...
    ("Ours: graph retriever + re-ranker", [
        ...
        ("A4_rgcn_notaxon_pair", "  factorised retriever: v3 + explicit co-presence (opportunity) term", "this work"),
        ("M6.0_system_factorised", "  factorised retriever + identity re-ranker", "this work"),
