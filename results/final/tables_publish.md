...
| *Ours* | | | | | | | | | | | | |
| R-GCN, taxon + cell nodes (plant-side leave-own-edges-out) | 0.150 | 0.962 | 0.368 | 0.006 | 0.761 | 0.166 | 0.010 | 0.766 | 0.158 | 0.032 | 0.969 | 0.257 |
...
|   factorised retriever + identity re-ranker (opportunity off within sites) | **0.230** | 0.972 | **0.386** | **0.162** | 0.926 | **0.427** | **0.142** | 0.907 | **0.403** | 0.051 | 0.974 | 0.296 |
...
| *Ours* | | | | | | |
| R-GCN, taxon + cell nodes (plant-side leave-own-edges-out) | 0.204 | 0.620 | 0.231 | 49 | 0.206 | 0.241 |
|   + identity re-ranker | 0.204 | 0.620 | 0.232 | 51 | — | — |
| R-GCN, taxon + cell nodes (symmetric leave-own-edges-out) | 0.215 | 0.629 | 0.234 | 52 | 0.217 | 0.226 |
...
|   factorised retriever + identity re-ranker (opportunity off within sites) | 0.217 | 0.636 | **0.249** | 54 | — | — |
