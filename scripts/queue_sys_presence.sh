...
RCFG="{\"field_dir\": \"$F\", \"softmax_weight\": 1.0, \"bce_weight\": 0.5, \"head_type\": \"elementwise\", \"use_degree_heads\": false, \"anchor_side\": \"both\", \"presence_input\": \"surface\", \"presence_fusion\": \"concat\"}"
FCFG="{\"field_dir\": \"$F\", \"identity_only\": true}"
NAME=M5.2_system_presence
sys () { # split seed
